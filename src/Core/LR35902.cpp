...
LR35902::LR35902(MMU& mmu, Gb_Apu& apu) : _mmu(&mmu), _apu(&apu) {
    reset();
                ...
                switch(opcode & 0x0F) {
                    ...
                    default: // Uncategorized codes
                        switch(opcode) {
                            ...
                            case 0x01:
                                set_bc(_mmu->read16(_pc));
                                _pc += 2;
                                break;
                            case 0x11:
                                set_de(_mmu->read16(_pc));
                                _pc += 2;
                                break;
                            case 0x21:
                                set_hl(_mmu->read16(_pc));
                                _pc += 2;
                                break;
                            case 0x31:
                                _sp = _mmu->read16(_pc);
                            ...
                            //
                            case 0x08:
                                _mmu->write16(_mmu->read16(_pc), _sp);
                                _pc += 2;
                                break; // 16bits LD
                            ...
                            default: std::cerr << "Unknown opcode: " << Hexa8(opcode) << std::endl; break;
                        }
                }
                break;
            }
                ...
                switch(opcode & 0x0F) {
                    ...
                    default: // Uncategorized codes
                        switch(opcode) {
                            ...
                            case 0xC2:
                                _pc += 2;
                                instr_jp(!check(Flag::Zero), _mmu->read16(_pc - 2));
                                break;
                            case 0xD2:
                                _pc += 2;
                                instr_jp(!check(Flag::Carry), _mmu->read16(_pc - 2));
                                break;
                            ...
                            case 0xC4:
                                _pc += 2;
                                instr_call(!check(Flag::Zero), _mmu->read16(_pc - 2));
                                break;
                            case 0xD4:
                                _pc += 2;
                                instr_call(!check(Flag::Carry), _mmu->read16(_pc - 2));
                                break;
                            ...
                            default: std::cerr << "Unknown opcode: " << Hexa(opcode) << std::endl; break;
                        }
                }
            }
        }
